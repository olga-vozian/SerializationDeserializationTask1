...
import EmployeeSerializationDeserialization.EmployeeSerializationDeserialization;
...
public class EmployeeSerializationDeserializationTest {
    ...
    File file = new File("src/test/resources/EmployeeSerializationDeserializationCollege.txt");
    ...
    public void deserializationEmployeeMethodTest() throws IOException, ClassNotFoundException {
        ...
        EmployeeSerializationDeserialization olga = (EmployeeSerializationDeserialization) objectInputStream.readObject();
